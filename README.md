...
## ⭐ Интересный факт
> В этом сервисе ноль строчек кода написано человеком — весь проект полностью сгенерирован с помощью модели gpt-5.1-codex-max, суммарно было затрачено около 700 000 токенов. В ручную производилось только тестирование сервиса. И именно поэтому сервис получил название The RubyVibe Bar — потому что это буквально «Ruby на вайбе», полностью написанный ИИ без человеческого участия.
